...
const PlayBar = observer(() => {
  ...
  return (
    <>
      ...
      {collect && (
        <CollectModal
          close={() => playcontroller.showCollect()}
          songId={song.id}
        />
      )}
      <div
      ...
      >
        ...
        <div className={styles.playmusic}>
          {/* 播放上一首 */}
          <StepBackwardOutlined
            className={styles['playmusic-div1']}
          ...
          {/* 播放下一首 */}
          <StepForwardOutlined
            className={styles['playmusic-div3']}
        ...
        <ul className={styles['music-bar']}>
          <li>
            <Slider
              ...
              step={song.dt / 1000}
              onChange={changeTime}
              onAfterChange={changeCurrentTime}
              value={time}
            />
            <small>
              {transTime(time, 2)}/{transTime(song.dt, 2)}
            </small>
          </li>
          <li>
            <div>
        ...
        <div className={styles['play-method']}>
          ...
          <div className={styles['play-sound']}>
            ...
            {showSloud && (
              <div className={styles['play-sound-container']}>
                <Slider
                  vertical
                  className={styles['play-sound-bar']}
                  onChange={(num) => {
                    playcontroller.changeVolume(num)
                  }}
                  value={voice}
                />
              </div>
          ...
          <img
            ...
            alt="logo"
            title={playlist.way.desc}
            onClick={() => {
              playlist.changePlayWay()
            }}
          />
          {/* 播放队列 */}
