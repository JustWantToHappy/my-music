        ...
        <div className={styles.content}>
          ...
          <figure>
            ...
            <div>
              ...
              <small>
                {new Date(currentlist.createTime).toLocaleString()}创建
              </small>
            </div>
          </figure>
          <small>
            歌单描述:&nbsp;
            {currentlist.description ? currentlist.description : '无'}
          </small>
        </div>
        {!mylove && (
          <div className={styles.btn}>
            <span>
              <FormOutlined
                onClick={() => {
                  navigate(`/mymc/editsonglist?id=${id}`, {
